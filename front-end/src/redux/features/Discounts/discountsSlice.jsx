...
export const discountsSlice = createSlice({
    ...
    reducers : {
        ...
        deleteDiscount : (state, action) => {
            ...
            const isExistDiscount = state.data.find(attribute => attribute.id === id)
            if(isExistDiscount)
            {
...
export const {initDataDiscount, addDiscount, deleteDiscount, updateDiscount } = discountsSlice.actions
