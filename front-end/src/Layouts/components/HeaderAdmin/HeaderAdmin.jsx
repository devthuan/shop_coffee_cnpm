    ...
    <div className=" w-full mx-auto px-2 md:px-4 ">
      <div className="items-start justify-between py-2 border-b md:flex">
        ...
        <div className="items-center gap-x-3 mt-6 md:mt-0 sm:flex">
          <div className="flex  px-4 py-2 text-center text-black hover:text-white duration-150 font-medium border rounded-lg hover:bg-indigo-500 active:bg-indigo-700 md:text-sm">
            <svg
