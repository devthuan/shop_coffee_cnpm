        ...
        <div className={cx("container justify-center")}>
          <div className={cx("max-w-[400px]  w-full mx-auto text-center left ")}>
            ...
            <form>
              ...
              <button onClick={(e)=>handleSubmit(e)} className={cx("w-full bg-yellow-500 text-white py-4 rounded-md mb-6")}>Sign Up</button>
            ...
            <div className={cx("bot-title")}>
              ...
              <span>You have an account yet?</span> 
               <Link to="/" className={cx("text-blue-500")}>Sign In</Link>
              </p>
            </div>
          </div>
        </div>
