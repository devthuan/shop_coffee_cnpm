    ...
    <div className={cx("grid lg:grid-cols-12 lg:gap-x-[30px] max-sm:gap-y-[20px]")}>
        ...
        <div style={{ width: '100%' }} className={cx("flex")}>
          ...
          <div style={{ width: '80%' }} className={cx("justify-start py-3 ")}>
            <div className={cx("flex justify-between")}>
              ...
              <p style={{ color: '#1A162E', fontSize: '20px', fontFamily: 'Arial, sans-serif', fontWeight: '700', wordWrap: 'break-word' }}>$476.00</p>
            </div>
            <div style={{ width: '100%' }} className={cx("flex justify-between items-center mt-2")}>
              ...
              <select style={{ height: 40, paddingLeft: 10, alignItems: 'center', borderRadius: 10, border: '1px #D2D1D6 solid', display: 'flex' }}>
      ...
      <div className={cx("lg:col-span-4 py-4 flex flex-col  gap-y-5")}>
        <div className={cx("w-full flex justify-between")}>
          ...
          <p style={{ fontFamily: 'Gordita, sans-serif' }} className={cx("text-2xl font-semibold")}>3</p>
        </div>
        ...
        <div className={cx("w-full flex justify-between")}>
          ...
          <p style={{ fontFamily: 'Gordita, sans-serif' }} className={cx("text-2xl font-semibold")}>190000</p>
        </div>
        ...
        <div className={cx("border-t border-gray-300 pt-4")}>
          <div className={cx("w-full flex justify-between")}>
            ...
            <p style={{ fontFamily: 'Gordita, sans-serif' }} className={cx("text-2xl font-semibold")}>210000</p>
          </div>
        </div>
        <div className={cx("pt-4")}>
          <button className={cx("text-3xl w-full h-[50px] bg-blue-500 text-white py-2 px-4 rounded-full")}>Continue to checkout</button>
        </div>
      </div>
    </div>
  );
