...
export const Cart = () => {
  return (
    <div className={cx("grid lg:grid-cols-12 lg:gap-x-[30px] max-sm:gap-y-[20px]")}>
      ...
      <div className={cx("lg:col-span-8 flex")}>
        <img style={{ width: '20%', height: 150 }} src="https://s3-alpha-sig.figma.com/img/0dc9/8023/1b3301cf80ceeab9071bd437ced0c257?Expires=1728864000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=I~jcd4t0EE23rSBlLXCW1tDzOF8l5E~ChHwVS103C6Sm0zAl5828VwZOiQt8nL3D7srt4wTFpKrhq5CWerVkPjC9uP-JFZ1LU-5wSQdewV4zL1QpWJBzMkCRQrF1ae7AtHvGNDrTVYSEMhyZV6FqIqDm~Kd5IwpLZGD3U-3ycoygemSoY2-5Pa2JefNEtAlhMM1DV9RzSFLlAYKM1UWMO91idp4kX3cl1oxyKkxHpQU3OFbP1HCWZbvT6JWs~jarV86P~CSoZByjH3LCsnvs9ovgG29iCyS1NqFM7RCMGSwGh38hMWLc~sebuP5tVNJSFAFPSBOm7j6hjwZIHJlGag__" alt="" />
        <div style={{ width: '78%' }} className={cx("justify-start py-3")}>
          <div className={cx("flex justify-between ")}>
            ...
            <p style={{ color: '#1A162E', fontSize: '20px', fontFamily: 'Arial, sans-serif', fontWeight: '700', wordWrap: 'break-word' }}>$47.00</p>
          </div>
          <div className="flex py-3">
            <span style={{ color: '#9E9DA8', fontSize: 18, fontFamily: 'Gordita', fontWeight: '500', wordWrap: 'break-word' }} >$47.00 |</span>
          ...
          <div className={cx("flex items-center w-full")}>
            <div className={cx("flex items-center w-1/2 ")}>
              <select style={{ marginRight: '10px', width: "50%", height: 44, paddingLeft: 10, alignItems: 'center', borderRadius: 10, border: '1px #D2D1D6 solid', display: 'flex' }}>
              ...
              <div style={{ width: '50%', height: 44, justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'inline-flex' }}>
                <div style={{ paddingLeft: 20, paddingRight: 20, paddingTop: 10, paddingBottom: 10, borderRadius: 10, border: '1px #D2D1D6 solid', justifyContent: 'center', gap: 10, display: 'flex' }}>
                  ...
                  <div style={{ color: '#1A162E', fontSize: 15, fontFamily: 'Gordita', fontWeight: '500', wordWrap: 'break-word' }}>1</div>
                  <div style={{ width: 24, height: 24, padding: 2, justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
                    <div style={{ width: 20, height: 20, position: 'relative' }}>
      ...
      <div className={cx("lg:col-span-8 flex")}>
        ...
        <div style={{ width: '78%' }} className={cx("justify-start py-3")}>
          <div className={cx("flex justify-between ")}>
            <p style={{ textAlign: 'start', color: '#1A162E', fontSize: '18px', fontStyle: 'normal', fontFamily: ' Tahoma, sans-serif', fontWeight: '500', wordWrap: 'break-word' }}>Coffee Beans - Espresso Arabica and Robusta Beans</p>
            <p style={{ textAlign: 'end', color: '#1A162E', fontSize: '20px', fontFamily: 'Arial, sans-serif', fontWeight: '700', wordWrap: 'break-word' }}>$47.00</p>
          </div>
          <div className="flex py-3">
            <span style={{ color: '#9E9DA8', fontSize: 18, fontFamily: 'Gordita', fontWeight: '500', wordWrap: 'break-word' }} >$47.00 |</span>
            <span style={{ paddingLeft: '5px', color: '#67B044', fontSize: 18, fontFamily: 'Gordita', fontWeight: '500', wordWrap: 'break-word' }}>In Stock</span>
      ...
      <div className={cx("lg:col-span-8 flex justify-end w-full")}>
        <div>
          <div className={cx("pb-4")} style={{ borderBottom: '1px solid #ccc' }}>
            <div className="flex items-center p-2 justify-between">
              <p style={{ color: '#1A162E', fontSize: 18, fontFamily: 'Gordita', fontWeight: '500', }} className={cx("pr-20 ")}>Subtotal</p>
              <p style={{ color: '#1A162E', fontSize: 18, fontFamily: 'Gordita', fontWeight: '500', }} className={cx()}>$191.65</p>
            </div>
      ...
      <div className={cx("g:col-span-4 flex align-top bg-red-200")}>
        <p>123</p>
      </div>
    </div>
  );
