...
export const RecoveryPass = () => {
  ...
  const handleResendPass = async (emailInput) => {
    if (emailInput?.trim() === "") {
  ...
  return (
    <div className={cx("flex flex-col items-center justify-center min-h-screen p-4")}>
      <div className="border border-solid border-gray-300 rounded-lg shadow-lg p-6 max-w-md w-full bg-white transition-transform duration-300 transform hover:scale-105">
        <h1 className="text-2xl font-bold mb-4 flex justify-center">
          <img src={grocery} alt="Logo" className="h-10  mb-2 justify-center gap-5 " />
          grocerymart
        </h1>
        <h2 className="text-2xl font-bold mb-4">Đặt lại tài khoản của bạn</h2>
        <p className="mb-6">Vui lòng nhập email hoặc số di động để đặt lại tài khoản của bạn.</p>
        {messageError && (
        ...
        <div className="flex space-x-4">
          ...
          <button className="bg-yellow-500 text-white rounded-lg px-4 py-2 hover:bg-yellow-600 transition duration-150"
