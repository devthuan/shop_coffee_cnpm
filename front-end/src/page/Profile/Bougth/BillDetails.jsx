                    ...
                    <div>
                        <div className="grid grid-cols-1 gap-4 mb-4">
                            <div className="p-2 bg-gray-100 rounded-lg flex justify-between items-center">
                                <div className="mb-4 text-xl">
                                    ...
                                    <p className="text-gray-600">ngày đặt hàng: {account.createdAt} </p>
                                </div>
                        ...
                        <table className="w-full mb-4 text-left border border-gray-300 text-xl">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="px-4 py-2 border-b">{productAttributes?.products?.name} - {productAttributes?.attributes?.name}</td>
